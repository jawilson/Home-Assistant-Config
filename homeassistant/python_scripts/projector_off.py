if hass.states.is_state('sun.sun', 'above_horizon'):
    ...
    kitchen_light_brightness = 125

dining_lights = hass.states.get('light.dining_lights_level')
if dining_lights.state != 'on' or \
        dining_lights.attributes.get('brightness') < dining_light_brightness:
    hass.services.call('light', 'turn_on', {'entity_id': 'light.dining_lights_level',
        'brightness': dining_light_brightness})

kitchen_lights = hass.states.get('light.kitchen')
